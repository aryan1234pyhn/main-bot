    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so CultBot doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m CultBot. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discord.com/api/oauth2/authorize?client_id=937277698370338887&permissions=8&scope=bot%20applications.commands)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [CultBot Support Server](https://discord.gg/Ek3nxsBwFR)!
        `)
        .setFooter('DM ΛGΞИT ム 𓆩ζ͜͡❥¡тαcнι♡ᵉˡˡʸ#2711 to speak directly with the developer!')
